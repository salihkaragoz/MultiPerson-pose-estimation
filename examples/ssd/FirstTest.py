...
caffe_root = '/home/salih/caffe/'  # this file is expected to be in {caffe_root}/examples
import os
os.chdir(caffe_root)
...
model_def = '/home/salih/caffe/models/VGGNet/VOC0712Plus/SSD_512x512_ft/deploy.prototxt'
model_weights = '/home/salih/caffe/models/VGGNet/VOC0712Plus/SSD_512x512_ft/VGG_VOC0712Plus_SSD_512x512_ft_iter_160000.caffemodel'
...
#print (ComparePlus)
for img in os.listdir('/home/salih/caffe/eval/val2017'):
    count = 0
    #for zimra in ComparePlus:
    #print(zimra,"1")
    count = count + 1
    ims = '/home/salih/caffe/eval/val2017/{}'.format(img)
    ...
    #top_indices = [i for i, conf in enumerate(det_conf) if conf >= 0.8 and i for i, labz in enumerate(det_label) if labz == 12.0]
    #print(zimra,"3")
    ...
    for i in xrange(top_conf.shape[0]):
        ...
        #with open('third_absent_plus_output_of_test.txt','a') as f:
            #f.write(str(line))
